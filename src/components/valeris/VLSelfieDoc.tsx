  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-center">
        <p className="text-sm text-muted-foreground mb-2">{!captured ? 'Segure seu documento ao lado do rosto' : 'Selfie com documento capturada'}</p>
        <p className="text-xs text-muted-foreground">Certifique-se de que seu rosto e o documento estejam visíveis</p>
      </div>
